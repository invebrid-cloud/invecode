  ...
  return (
    <div className="flex-1 space-y-8 p-4 md:p-8">
          ...
          <Card key={plan.id} className="flex flex-col shadow-lg hover:shadow-primary/20 transition-shadow duration-300">
            ...
            <CardFooter>
              <Button asChild className="w-full">
                <Link href={`/authPages/login`}>Invest Now</Link>
              </Button>
            </CardFooter>
          </Card>
        ))}
      ...
      <section className="text-center pt-8 pb-16">
            ...
            <div className="mt-8">
                <Link href="/publicPages/contact" className="text-primary text-lg font-medium hover:underline flex items-center justify-center gap-2">
